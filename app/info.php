...
<body>
    <div class="contenedor">
        ...
        <img src="estilos/FISHnet.png" alt="Logo FISHnet" style="display: block; margin: 20px auto; max-width: 2000px; height: auto;">
        <br><br>
        <div class="panel-column" style="margin-top: 30px;" >

...
<body>
  <header>
    ...
    <div class="perfil">
      ...
      <button class="menu-btn" onclick="toggleMenu()"><img src="mostrar_foto.php" alt="Foto de perfil" style="width:60px; height:60px; object-fit:cover; border-radius:50%;"></button>
      <div class="menu" id="menu">
        <a href="guardar_datos.php">Cambiar datos</a>
        <a href="Historial.h">Historial de acciones</a>
